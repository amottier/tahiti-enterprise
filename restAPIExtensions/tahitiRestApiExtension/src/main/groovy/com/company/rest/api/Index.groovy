	...
	RestApiResponse doHandle(HttpServletRequest request, RestApiResponseBuilder responseBuilder, RestAPIContext context) {
		...
		for(user in users) {
			...
			for(currentUserVacationRequest in currentUserVacationRequests) {
				...
				def vacationRequestInfo = [firstName: user.firstName, lastName: user.lastName, startDate: currentUserVacationRequest.startDate, returnDate: currentUserVacationRequest.returnDate, numberOfDays: currentUserVacationRequest.numberOfDays, status: currentUserVacationRequest.status, taskId: reviewRequestTaskId]
